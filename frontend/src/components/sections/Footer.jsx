...
import FooterMarque from "../layout/FooterMarque";
...
const Footer = () => {
  ...
  return (
    <div className="bg-[#272727] h-[62vh] w-full flex flex-col relative">
      <div
        className="w-full h-[50vh] grid gap-2 p-8"
        style={{
      ...
      >
        <div
          className="rounded-xl bg-[#272727] border border-white/10 p-8 flex flex-col justify-between"
          style={{ gridArea: "box1" }}
        >
          <div>
            ...
            <h3 className="text-2xl md:text-3xl font-extrabold bg-clip-text text-transparent bg-linear-to-r from-blue-400 to-cyan-400 mb-4">
              Extraordinary
            </h3>
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              Building digital experiences that blend creativity with
              functionality. Let's collaborate and bring your vision to life.
            </p>

            <nav className="mt-6 flex flex-wrap gap-3">
              <a
                href="/about"
                className="text-sm text-gray-300 hover:text-white underline-offset-2"
              >
                About
              </a>
              <a
          ...
          <div className="mt-6">
            ...
            >
              <input
                ...
                className="px-3 py-2 rounded-md bg-[#1b1b1b] text-white border border-white/10 focus:outline-none focus:ring-2 focus:ring-blue-400"
              />
            ...
            <div className="mt-4 flex items-center gap-3">
              <p className="text-sm text-gray-400 mr-2">Follow</p>
              <div className="flex items-center gap-2">
                <a
                  ...
                  title="Instagram"
                  className="p-2 rounded-full focus:outline-none focus:ring-2 focus:ring-white/30"
                >
                  <SocialIcon
                    type="instagram"
            ...
            <div className="mt-4 text-xs text-gray-500">
              Recreated with code by Aman404Found — Original Design by Zaid Khan
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <SocialIcon
              type="github"
              color={
                hoveredBox === "github" ? hoverIconColor : defaultIconColor
              }
              size="48px"
            />
          </a>
        ...
        >
          ...
          >
            <SocialIcon
              type="twitter"
              color={
                hoveredBox === "twitter" ? hoverIconColor : defaultIconColor
              }
              size="48px"
            />
          </a>
